      ...
      <main className={styles.main}>
        <div className={styles.content}>
          <header className={styles.header}>
            ...
            <h1 className={styles.title}>Gestão do Setor</h1>
            <p className={styles.subtitle}>Painel de controle e configurações administrativas do comercial.</p>
          </header>
          <div className={styles.grid}>
            <div className={styles.card}>
              <div className={styles.cardBody}>
                <h3 className={styles.cardTitle}>Configurações</h3>
                <p className={styles.cardDesc}>Ajuste parâmetros de vendas e fluxos de trabalho.</p>
              </div>
